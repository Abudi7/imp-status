 ...
 */
final class Version20230510080657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscription ADD system_status_id INT NOT NULL');
        $this->addSql('ALTER TABLE subscription ADD CONSTRAINT FK_A3C664D368280800 FOREIGN KEY (system_status_id) REFERENCES system_status (id)');
        $this->addSql('CREATE INDEX IDX_A3C664D368280800 ON subscription (system_status_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscription DROP FOREIGN KEY FK_A3C664D368280800');
        $this->addSql('DROP INDEX IDX_A3C664D368280800 ON subscription');
        $this->addSql('ALTER TABLE subscription DROP system_status_id');
