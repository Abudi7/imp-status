 ...
 */
final class Version20230515061223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE system_status ADD maintenance_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6B8ED0DDF6C202BC ON system_status (maintenance_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6B8ED0DDF6C202BC ON system_status');
